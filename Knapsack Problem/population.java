...
public class population
{
    ...
    public population()
    {
        ...
        int mutationsrate = 100;                    // Wahrscheinlichkeit von Mutation = mutationsrate / 1000 
    ...
    public Rucksack Crossover(Rucksack r1, Rucksack r2){
        int crossoverIndex = rand.nextInt(anzahlMoeglicheItems);
        r1.Crossover(r2,crossoverIndex);
        return r1;
    }
    ...
    public void printPopulationsBesten(){
        ...
        System.out.println("Bestes Individuum der Population:"+ populationsNummer + "   Fitness: " + temp);
